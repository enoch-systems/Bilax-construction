        ...
        <div className="mb-14 grid gap-10 md:grid-cols-3 md:gap-12">
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="#" className="cursor-pointer flex h-10 w-10 items-center justify-center rounded-sm border border-white/20 bg-white/5 text-slate-300 transition-all hover:border-amber-500/30 hover:bg-amber-500/10 hover:text-amber-100">
